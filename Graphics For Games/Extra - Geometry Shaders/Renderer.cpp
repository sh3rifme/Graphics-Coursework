...
Renderer::Renderer(Window &parent) : OGLRenderer(parent)	{
	...
	currentShader = new Shader(	SHADERDIR"vertex.glsl",
	...
	emitter->SetTexture(SOIL_load_OGL_texture(TEXTUREDIR"fruit.png",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_COMPRESS_TO_DXT));
